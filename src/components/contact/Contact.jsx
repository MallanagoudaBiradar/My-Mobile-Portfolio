   ...
   variants={staggerContainer}
    ...
    <motion.div >
        ...
        <TitleText title="Get in touch" />
         <motion.span variants={fadeIn('up', 'tween', 0.6, 1)} className="section__subtitle">If you have a job, proposal, or collaboration opportunity, I'll promptly get back to you. <br /> forward to the possibility of working together.</motion.span>
    </motion.div>
        ...
        <div className="contact content">
            ...
            <div className="contact__info">
                <motion.div variants={fadeIn('up', 'spring', 0.2, 1)} className="contact__card">
                    ...
                    <span className="contact__card-data">mallanagoudarbiradar@gmail.com</span>

                    <a href="mailto:mallanagoudarbiradar@gmail.com?subject=Proposal&body=Hello Mallanagouda, this is ..." target='_blank' 
                ...
                <motion.div variants={fadeIn('up', 'spring', 0.4, 1)} className="contact__card">
                    ...
                    <span className="contact__card-data">@Mallanagoudarb7</span>

                    <a href='https://twitter.com/Mallanagoudarb7' target='_blank' className="contact__button">Write me <i className="bx bx-right-arrow-alt contact__button-icon"></i></a>
                </motion.div>
