...
const Social = () =>  (
 ...
 >
    ...
    <motion.a variants={fadeIn('down', 'spring', 0.4, 1)} href="https://www.linkedin.com/in/mrbiradar" className="home__social-icon" target='_blank' rel='noreferrer' ><i className="uil uil-linkedin"></i></motion.a>
